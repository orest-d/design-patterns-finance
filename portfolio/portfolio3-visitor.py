...
class Visitor:
    ...
    def visit_underlying(self, asset):
        print("Underlying: " + str(asset))
...
class VanillaCallOption(Asset):
    ...
    def accept(self, visitor):
        visitor.visit_asset(self)
        visitor.visit_underlying(self.asset)
...
class Position(Asset):
    ...
    def accept(self, visitor):
        visitor.visit_asset(self.asset)
        self.asset.accept(visitor)

    def __str__(self):
        return f"{self.amount} of {self.asset}"
